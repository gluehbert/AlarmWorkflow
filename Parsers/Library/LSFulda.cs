...
{
    [Export("LSFuldaParser", typeof(IParser))]
    public class LSFuldaParser : IParser
    {
        #region Fields

        // "ALARM; Einsatzort: Dipperz;Friesenhausen; Adresse: Am Grahlen;;;; Alarmstichwort: B;F1;F1;; Alarmierte Einheiten: DIP 6-47-1,FF Dipperz LG,DIP 01,FF Friesenhausen,DIP WBK (1-40-1),DIP 1-40-1"

        private readonly string[] _keywords = new[]
            {
                "MELDEBILD", "2", "BEMERKUNG","EINGABEFELD", "OHNE", "MIT", "ORTSTEIL", "STRAßE", "STICHWORT", "ALARMIERTE EINHEITEN"
            };
                ...
                try
                {
                    ...
                    switch (section)
                    {
                        case CurrentSection.ADaten:
                            ...
                            {
                                case "2":
                                    operation.Timestamp = DateTime.Parse(msg);
                                    break;
                                case "OHNE":
                                    operation.Priority = "Ohne Sondersignal";
                                    break;
                                case "MIT":
                                    operation.Priority = "MIT SONDERSIGNAL";
                                    break;
                                case "BEMERKUNG":
                                case "MELDEBILD":
